...
$('#btnCreate').on('click', () => {
    ...
    let createProduct = new CreateProduct();
     ...
     createProduct.title = $('#nameCr').val();
     createProduct.slug = $('#slugCr').val();
     createProduct.content = $('#descriptionCr').val();
    createProduct.category = $('#categoryCr').val();
    // let status = $('#statusCr').val();


    console.log(JSON.stringify(createProduct));
